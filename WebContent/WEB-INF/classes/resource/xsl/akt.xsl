...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ds="http://www.w3.org/2000/09/xmldsig#"
    version="1.0">
    ...
    <xsl:template match="/Akt">
        <html>
            ...
            <body style="font-family:Helvetica">
                <br/>
                <h1 align="center" style="font-size:16pt; margin-top:93pt" ><xsl:value-of select="@naziv"/></h1>
    ...
    <xsl:template match="Deo">
        ...
        <h2 align="center" style="font-size:12.2pt; margin-top:23pt"><xsl:value-of select="Naziv"/></h2>
